...
export const ADD_PHONE_TO_BACKET = 'ADD_PHONE_TO_BACKET';
...
export const CHECKOUT_PHONES = 'CHECKOUT_PHONES';

export const INCREMENT_COUNT_PHONES = 'INCREMENT_COUNT_PHONES'; 

export const DECREMENT_COUNT_PHONES = 'DECREMENT_COUNT_PHONES'; 
